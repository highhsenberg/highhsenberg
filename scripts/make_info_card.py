...
# ===========================================================================
HOST = "highhsenberg"   # shown as  highhsenberg@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "GTM & AI Automation Engineer @ Qelvora.ai"),
    ("kv", "Since", "Aug 2024"),
    ("kv", "Edu", "B.Tech CSE, VIT '23"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Automation", "n8n, Make.com, Zapier, Clay"),
    ("kv", "GTM", "Apollo, HubSpot, Salesforce, Smartlead"),
    ("kv", "AI", "Claude, Claude Code, ChatGPT, Prompt Eng."),
    ("kv", "Other", "Python, REST APIs, Figma, Shopify"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "AI email personalizer cut writing time 80%"),
    ("bul", "Cut manual processing 67%, lifted accuracy 43%"),
    ("bul", "2,500+ qualified accounts sourced across 10+ verticals"),
]
